    ...
    <>
      ...
      <div
        style={{
          position: "fixed",
          bottom: 28,
          left: 20,           /* ← LEFT side — away from Ask Shuddh on the right */
          zIndex: 9999,
          display: "flex",
          flexDirection: "column",
          alignItems: "flex-start",   /* panel anchors to left */
          gap: 8,
        }}
      >
        ...
        >
          {/* Pulsing WhatsApp circle — always leftmost */}
          ...
          {/* Label — hidden on mobile, visible on desktop, sits to the RIGHT of icon */}
          <div
