...
/* ─── Data ─────────────────────────────────────────────────────────── */
const VIDEO_DATA = [
  { id: 1, src: "/testimonials/video7.mp4?v=3", poster: "/testimonials/poster7.jpg?v=3", name: "Patient Story #1", condition: "Asthma from childhood", stars: 5 },
  { id: 2, src: "/testimonials/video2.mp4?v=2", poster: "/testimonials/poster2.jpg?v=2", name: "Patient Story #2", condition: "Chronic skin & digestion problem", stars: 5 },
  { id: 3, src: "/testimonials/video3.mp4?v=2", poster: "/testimonials/poster3.jpg?v=2", name: "Patient Story #3", condition: "Excessive vomiting & stomach infection", stars: 5 },
  { id: 4, src: "/testimonials/video4.mp4?v=2", poster: "/testimonials/poster4.jpg?v=2", name: "Patient Story #4", condition: "Allergic bronchitis", stars: 5 },
  { id: 5, src: "/testimonials/video5.mp4?v=2", poster: "/testimonials/poster5.jpg?v=2", name: "Patient Story #5", condition: "Allergic cough and cold", stars: 5 },
  { id: 6, src: "/testimonials/video1.mp4?v=2", poster: "/testimonials/poster1.jpg?v=2", name: "Patient Story #6", condition: "Allergic cough and cold", stars: 5 },
] as const;
